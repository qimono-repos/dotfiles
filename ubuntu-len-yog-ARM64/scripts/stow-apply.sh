...
PACKAGES=(shell guix-env quantum nvim jupyter)
...
# NOTE: the AMD pack additionally runs flatpak/ghostty host link helpers
# (link-flatpak-exports.sh, link-ghostty-appdir.sh, …). Those are flatpak-only
# and out of scope for the Snapdragon bootstrap until flatpak is opted in.
